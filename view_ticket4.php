    ...
    <body>
       ...
       <hr/>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="2c.jpg" alt="Train image"  height="350px" width="460px">
                </div>
                <div class="col-lg-6">
                    <h1><u>Tezgam Express</u></h1>
                    <h3>Type:</h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="clr">
                <form action="" id="clr1">
					...
					<div class="form-group row"> 
					    <div class="col-sm-3 offset-sm-1">
                            <label for="date" class="col-form-label"><b>Expiry Month & Year:</b></label>
                        </div>
                        <div class="col-sm-5">
	    ...
	    <div   class="modal-content">
            ...
            <div class="modal-body" id="clr">
			    <div    class="container" style="background-color: #D6EAF8 ;border-radius: 10px;padding: 40px;">
				    <div class="row">
						<div class="col-lg-6">
							<img src="2c.jpg" alt="Train image"  height="250px" width="300px">
						</div>
						<div class="col-lg-6">
							<h3>Tezgam Express</h3>
							<h5>Type:</h5>
							<p class="pp">First class</p>
							<h5>Travel:</h5>
							<p class="pp">Lahore to Karachi</p> 
